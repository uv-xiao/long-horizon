...
- Implemented the v2 prompt-first usability layer with target-agent capability analysis, cached operation-mode decisions, runtime-owned/native-agent/hybrid install behavior, phase prompt templates, installable skills, task setup artifacts, and v2 verification coverage.
